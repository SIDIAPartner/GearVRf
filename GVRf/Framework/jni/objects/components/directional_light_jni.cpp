...
extern "C" {
	...
	JNIEXPORT void JNICALL
	Java_org_gearvrf_NativeDirectionalLight_setSpotangle(JNIEnv * env,
			jobject obj,  jlong ref, jfloat angle);
	...
	JNIEXPORT void JNICALL
	Java_org_gearvrf_NativeDirectionalLight_setBias(JNIEnv * env,
			jobject obj,  jlong ref, jfloat value);
	...
	Java_org_gearvrf_NativeDirectionalLight_getNewDirectionalLight(JNIEnv * env, jobject obj);
...
Java_org_gearvrf_NativeDirectionalLight_setLightDirection(JNIEnv * env,
	...
	DirectionalLight* directionalLight = reinterpret_cast<DirectionalLight*>(ref);
...
Java_org_gearvrf_NativeDirectionalLight_setShadowMapHandlerEdges(JNIEnv * env,
	...
	{
	case 0:
		directionalLight->setShadowMapHandlerEdges(DirectionalLight::HANDLER_EDGES_NONE);
		break;
	case 1:
		directionalLight->setShadowMapHandlerEdges(DirectionalLight::HANDLER_EDGES_DARK);
		break;
	case 2:
		directionalLight->setShadowMapHandlerEdges(DirectionalLight::HANDLER_EDGES_LIGHT);
		break;
	}
