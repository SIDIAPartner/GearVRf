...
public:
    ...
    void render(
    		const glm::mat4& mvp_matrix_cam,
			const glm::mat4& mvp_matrix_light_cam,
			const glm::mat4& mv_matrix, const glm::mat4& mv_it_matrix, const glm::mat4& mv_it_cam,  const glm::mat4& mv_it_model,
