...
void Renderer::calcShadow(ShaderManager* shader_manager,
            ...
            for (int curr_pass = 0; curr_pass < render_data->pass_count();
                ...
                if (curr_material != nullptr && nullptr != t) {
                    ...
                    try {
                        ...
                        glm::mat4 vp_matrixLightModel; // << input
                        glm::vec3 lightPosition; // << input

                        calcShadow(shader_manager, curr_material, model_matrix,
                                modeShadow, lightPosition, vp_matrixLightModel); // calculates
