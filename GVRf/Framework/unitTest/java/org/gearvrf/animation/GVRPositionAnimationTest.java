...
public class GVRPositionAnimationTest {

    GVRPositionAnimation animation;
   ...
   public void animateTest() throws Exception {
       ...
       animation = new GVRPositionAnimation(sceneObject, duration, positionX, positionY, positionZ);
